...
> ⚠️ **Снапшот аудита 2026-07-22 — не актуальное состояние.** Часть находок ниже давно
> исправлена, ссылки `файл:строка` устарели (код переехал). Что реально открыто сегодня —
> в [11-status.md](11-status.md).
