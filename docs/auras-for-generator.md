...
**`aura_image`** — фон под метками. Заполняется для тех кто не человек и не маг. Это отображение их сущности. Пусто или NULL → приложение рисует стандартную ауру по
...
Не уверены — берите `magic_link_neutral.png`, а лучше скажите что отрисовать или найдите картинку.
